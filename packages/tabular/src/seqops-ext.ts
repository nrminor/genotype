...
import { type ColumnId, type Fx2TabOptions, fx2tab, TabularOps } from "./fx2tab";
...
/**
 * Named export to make extension import explicit (trait-style).
 * Importing this symbol applies SeqOps tabular methods at module load time.
 */
export const SeqOpsTabularExt = (() => {
  ...
  return "SeqOpsTabularExt" as const;
})();
