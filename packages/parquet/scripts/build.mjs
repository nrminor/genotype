...
const tsconfigBuild = {
  compilerOptions: {
    ...
    paths: {
      ...
      "@genotype/tabular": ["../tabular/dist/index.d.ts"],
      "@genotype/tabular/*": ["../tabular/dist/*"],
      "@genotype/parquet": ["./src/index.ts"],
      "@genotype/parquet/*": ["./src/*"],
    },
  },
  include: ["src/**/*"],
...
const distPackageJson = {
  ...
  main: "index.js",
  types: "index.d.ts",
  sideEffects: ["./index.js", "./seqops-ext.js", "./tabular-ext.js"],
  exports: {
    ".": {
      import: "./index.js",
      require: "./index.js",
    ...
    "./tabular-ext": {
      ...
      require: "./tabular-ext.js",
      types: "./tabular-ext.d.ts",
    },
    "./reader": {
      import: "./reader.js",
      require: "./reader.js",
    ...
    "./wasm-init": {
      import: "./wasm-init.js",
      require: "./wasm-init.js",
      types: "./wasm-init.d.ts",
    },
    "./errors": {
      import: "./errors.js",
      require: "./errors.js",
